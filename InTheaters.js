module.exports = function () {
    ...
    this.GetData = () => {
        ...
        console.log('开始获取' + curpage + '-' + toCount + ' 热映榜 数据');
    ...
    this.UpdateData = data => {
        ...
        let params = {
            app_key: app_key,
            datas: data,
            model_name: 'inTheaters',
            sign: md5(app_key + data + 'inTheaters' + 'App.Table.MultiCreate' + app_secrect).toUpperCase()
        };
        console.log('开始导入 热映榜 数据');
            ...
            res.on('end', () => {
                ...
                if (strem.ret == '200') {
                    if(curpage + pagesize < total){
                        console.log(' 热映榜 导入成功');
                        curpage += pagesize;
                        obj.GetData();
                    }else{
                        console.log(' 热映榜 数据更新完成');
                        uploadLog.UpLog(' 热映榜 数据更新完成','INFO');
                    }
                } else {
                    console.log(strem);
                }
    ...
    this.DeleteData = data => {
        ...
        let params = {
            ...
            sign: md5(app_key + 'inTheaters' + 'App.Table.FreeDelete' + JSON.stringify([
                ["id", "<>", ""]
    ...
    this.GetSqlData=function(start=1,count=20,response){
        let params = {
            ...
            sign: md5(app_key + 'inTheaters'+start+count + 'App.Table.FreeQuery' + JSON.stringify([
                ["id", "<>", ""]
            ]) + app_secrect).toUpperCase()
        };
        //console.log(data);
