module.exports = function () {
    ...
    this.UpdateData = data => {
        ...
        let params = {
            ...
            sign: md5(app_key + data + 'newMovies' + 'App.Table.MultiCreate' + app_secrect).toUpperCase()
        };
        console.log('开始导入 新片榜 数据');
        ...
        let req = http.request(options, function (res) {
            ...
            res.on('end', () => {
                strem = JSON.parse(strem);
                if (strem.ret == '200') {
                    console.log(' 新片榜 数据更新完成');
                    uploadLog.UpLog(' 新片榜 数据更新完成','INFO');
                } else {
                    console.log(strem);
                }
                //myres.write(strem);
    ...
    this.DeleteData = data => {
        ...
        let params = {
            ...
            sign: md5(app_key + 'newMovies' + 'App.Table.FreeDelete' + JSON.stringify([
                ["id", "<>", ""]
    ...
    this.GetSqlData=function(start=1,count=20,response){
        let params = {
            ...
            sign: md5(app_key + 'newMovies'+start+count + 'App.Table.FreeQuery' + JSON.stringify([
                ["id", "<>", ""]
            ]) + app_secrect).toUpperCase()
        };
        //console.log(data);
